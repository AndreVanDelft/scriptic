...
class InitializerBlockContext extends RefinementContext {
  public InitializerBlockContext (CompilerEnvironment env, ParserErrorHandler parserErrorHandler, InitializerBlock owner) {
      super (env, parserErrorHandler, owner);
      this.owner = owner;
  }
  public InitializerBlock owner;
  ...
  Variable resolveLocalName (NameExpression e, boolean fromLocalOrNestedClass) throws CompilerError {
      Variable result = super.resolveLocalName (e, fromLocalOrNestedClass);
      if (result != null
