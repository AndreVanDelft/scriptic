...
class ConstantChar extends ConstantSmallOrNormalInteger {
   char value;
   public int intValue() {return value;}
   public ConstantChar (char value) {this.value=value;}
   public DataType dataType(CompilerEnvironment env) {return CharType.theOne;}
   ...
   public Object makeObject() {return new Character(value);}
}
