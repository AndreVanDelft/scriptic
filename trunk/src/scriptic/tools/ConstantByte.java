...
class ConstantByte extends ConstantSmallOrNormalInteger {
   byte value;
   public int intValue() {return value;}
   public ConstantByte (byte value) {this.value=value;}
   public DataType dataType(CompilerEnvironment env) {return ByteType.theOne;}
