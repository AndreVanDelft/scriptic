...
class NodeOldDuration extends NodeDuration {
   public static NodeOldDuration theOne = new NodeOldDuration();
   Instruction [] loadInstructions  (CompilerEnvironment env, ClassType constantPoolOwner, InstructionOwner instructionOwner)
      ...
      Method m = env.mustResolveMethod (env.scripticVmNodeType, "oldDuration", "()D");
