...
public final class ShortHolder  extends ValueHolder {
    public ShortHolder(){}
    public ShortHolder(short v){value=v;}
    public short value;
    /** 
     * set the value to the other's value; 
     * the other ValueHolder must have the same type 
     */
    public void setValue (ValueHolder other) {value=((ShortHolder)other).value;}
    ...
    public boolean equals (Object other) {
       ...
       ShortHolder otherShortHolder = (ShortHolder) other;
       return value==otherShortHolder.value;
    }    
