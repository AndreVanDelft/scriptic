...
/**
 * Parallel operator but not break '/'
 */
class NotBreakParallelNode extends ParallelNode {

	NotBreakParallelNode (NodeTemplate template, Node parent) {super (template, parent);}
