...
class LocalScriptVariableDeclaration extends LocalVariableDeclaration {
   public String getConstructName () {return "local script variable";}
   public LocalVariable makeTarget (CompilerEnvironment env) {
      LocalVariable result      = new ScriptLocalVariable();
      result.source             = this;
      result.name               = name;
