...
class DimensionCastExpression extends JavaExpression {
   public JavaExpression                  unaryExpression;
   public CompoundDimensionDeclaration compoundDimensionDeclaration; // (dimension 1/time)
   ...
   public int languageConstructCode () {return DimensionCastExpressionCode;}
