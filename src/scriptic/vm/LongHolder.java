...
public final class LongHolder  extends ValueHolder {
    public LongHolder(){}
    public LongHolder(long v){value=v;}
    public long value;
    /** 
     * set the value to the other's value; 
     * the other ValueHolder must have the same type 
     */
    public void setValue (ValueHolder other) {value=((LongHolder)other).value;}
    ...
    public boolean equals (Object other) {
       ...
       LongHolder otherLongHolder = (LongHolder) other;
       return value==otherLongHolder.value;
    }    
    public int hashCode() {
