...
/** 
 * This class serves storing receive-channel frames
 *
 * @version 	1.0, 11/30/95
 * @author	Andre van Delft
 */

public class ReceiveChannelFrame extends CommFrame {
	public ReceiveChannelFrame (Object owner, NodeTemplate template, ValueHolder[] indexValues, RootNode rootNode) {
	    super (owner,template, indexValues, rootNode);
	}
	void activateWhenAllPartnerActive() {
	    if (_activePartners==1) {
		_trialTree = new ReceiveChannelNode(this, rootNode);
